namespace GeneralAlgorithms.Algorithms.Graphs.GraphDecomposition
{
		...
		where TNode : IEquatable<TNode>
	{
		...
		private List<TNode> GetNeighbouringPath(IGraph<TNode> graph, Dictionary<TNode, bool> usedVertices)
		{
		...
		private List<TNode> GetSmallestNeighbouringCycle(IGraph<TNode> graph, List<List<TNode>> faces, Dictionary<TNode, bool> usedVertices)
		{
