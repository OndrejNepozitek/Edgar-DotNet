...
namespace GeneralAlgorithms.Tests.DataStructures.Common
{
    ...
    public class OrthogonalLineTests
    {
        ...
        {
            Assert.AreEqual(OrthogonalLineGrid2D.Direction.Bottom,
                OrthogonalLineGrid2D.RotateDirection(OrthogonalLineGrid2D.Direction.Right, 90));
            Assert.AreEqual(OrthogonalLineGrid2D.Direction.Top,
                OrthogonalLineGrid2D.RotateDirection(OrthogonalLineGrid2D.Direction.Bottom, -180));
        }
