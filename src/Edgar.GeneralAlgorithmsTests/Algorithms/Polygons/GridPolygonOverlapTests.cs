...
namespace GeneralAlgorithms.Tests.Algorithms.Polygons
{
    ...
    internal class GridPolygonOverlapTests
    {
        ...
        public void OverlapArea_PlusShapeAndSquare()
        {
            ...
            {
                Assert.AreEqual(5,
                    polygonOverlap.OverlapArea(p1.Rotate(degrees), new Vector2Int(0, 0), p2.Rotate(degrees),
                        new Vector2Int(3, 3).RotateAroundCenter(degrees)));
            }
        }
        ...
        public void DoHaveMinimumDistance_TwoSquares()
        {
            ...
            Assert.IsTrue(
                polygonOverlap.DoHaveMinimumDistance(r1, new Vector2Int(0, 0), r2, new Vector2Int(10, 10), 4));
            Assert.IsFalse(
                polygonOverlap.DoHaveMinimumDistance(r1, new Vector2Int(0, 0), r2, new Vector2Int(10, 10), 5));
