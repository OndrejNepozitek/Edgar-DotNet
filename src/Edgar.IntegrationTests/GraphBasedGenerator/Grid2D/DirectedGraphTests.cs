    ...
    public class DirectedGraphTests
    {
        ...
        public void BasicDoorTypeTest()
        {
...

            {
                ...
                Assert.That(door.DoorLine,
                    Is.EqualTo(new OrthogonalLineGrid2D(new Vector2Int(5, 3), new Vector2Int(5, 2))));
        ...
        public void BasicDoorTypeTestOpposite()
        {
...

            {
                ...
                Assert.That(door.DoorLine,
                    Is.EqualTo(new OrthogonalLineGrid2D(new Vector2Int(0, 2), new Vector2Int(0, 3))));
                Assert.That(door.Type, Is.EqualTo(DoorType.Entrance));
            }
        ...
        public void BasicCorridorDoorTypeTest()
        {
            ...
            var corridorRoomTemplate = new RoomTemplateGrid2D(PolygonGrid2D.GetRectangle(3, 1),
            ...
            levelDescription.AddRoom(2,
                new RoomDescriptionGrid2D(true, new List<RoomTemplateGrid2D>() {corridorRoomTemplate}));
