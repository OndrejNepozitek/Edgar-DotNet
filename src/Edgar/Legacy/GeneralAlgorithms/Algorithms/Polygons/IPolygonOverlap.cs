...
namespace Edgar.Legacy.GeneralAlgorithms.Algorithms.Polygons
{
    ...
    public interface IPolygonOverlap<in TShape>
    {
        ...
        /// <returns></returns>
        bool DoTouch(TShape polygon1, Vector2Int position1, TShape polygon2, Vector2Int position2,
            int minimumLength = 0);
        ...
        /// <returns></returns>
        bool DoHaveMinimumDistance(TShape polygon1, Vector2Int position1, TShape polygon2, Vector2Int position2,
            int minimumDistance);
        ...
        /// <returns></returns>
        IList<Tuple<Vector2Int, bool>> OverlapAlongLine(TShape movingPolygon, TShape fixedPolygon,
