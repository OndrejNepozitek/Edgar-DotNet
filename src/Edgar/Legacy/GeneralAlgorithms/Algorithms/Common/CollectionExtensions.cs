...
namespace Edgar.Legacy.GeneralAlgorithms.Algorithms.Common
{
    public static class CollectionExtensions
    {
        ...
        /// <returns></returns>
        public static bool SequenceEqualWithoutOrder<T>(this IEnumerable<T> firstEnumerable,
            IEnumerable<T> secondEnumerable)
        {
        ...
        /// <param name="func"></param>
        /// <returns></returns>
        public static TElement MinElement<TElement, TResult>(this IList<TElement> collection,
        ...
        public static T GetWeightedRandom<T>(this IList<T> elements, Func<T, double> weightSelector, Random random)
        {
            ...
            throw new InvalidOperationException(
                "Should never get here. If we get here, nothing was chosen because of rounding errors of doubles.");
        }
    }
}