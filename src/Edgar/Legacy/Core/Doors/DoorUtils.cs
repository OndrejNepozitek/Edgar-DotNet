    ...
    public static class DoorUtils
    {
                        ...
                        while (nextDoorLineNode != null)
                        {
                            ...
                            if (doorLine.Line.To + doorLine.Line.GetDirectionVector() == otherDoorLine.Line.From)
                            {
                                doorLine = new DoorLine(
                                    new OrthogonalLineGrid2D(doorLine.Line.From, otherDoorLine.Line.To),
                                    doorLine.Length);
                                found = true;
                            ...
                            {
                                doorLine = new DoorLine(
                                    new OrthogonalLineGrid2D(otherDoorLine.Line.From, doorLine.Line.To),
                                    doorLine.Length);
                                found = true;
                                sameDirectionDoorLines.Remove(otherDoorLineNode);
                            }
                        ...
                        while (nextDoorLineNode != null)
                        {
                            ...
                            if (doorLine.Line.To + doorLine.Line.GetDirectionVector() == otherDoorLine.Line.From)
                            {
                                doorLine = new DoorLineGrid2D(
                                    new OrthogonalLineGrid2D(doorLine.Line.From, otherDoorLine.Line.To),
                                    doorLine.Length, doorLine.DoorSocket, doorLine.Type);
                                found = true;
                                sameDirectionDoorLines.Remove(otherDoorLineNode);
                            }
                            else if (doorLine.Line.From - doorLine.Line.GetDirectionVector() == otherDoorLine.Line.To)
        ...
        public static DoorLine TransformDoorLine(DoorLine doorLine, TransformationGrid2D transformation)
        {
            ...
            var newDoorPosition = new OrthogonalLineGrid2D(lastEndPoint,
                lastEndPoint + transformedLine.Length * transformedLine.SwitchOrientation().GetDirectionVector(),
                newDirection);
        ...
        private static OrthogonalLineGrid2D.Direction TransformDirection(
            OrthogonalLineGrid2D.Direction originalDirection, TransformationGrid2D transformation)
        {
