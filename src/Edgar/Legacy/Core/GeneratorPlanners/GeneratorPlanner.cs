...
namespace Edgar.Legacy.Core.GeneratorPlanners
{
        ...
        where TLayout : ISmartCloneable<TLayout>
    {
        ...
        public TLayout Generate(TLayout initialLayout, List<Chain<TNode>> chains,
            ILayoutEvolver<TLayout, TNode> layoutEvolver)
        {
            ...
            while (true)
            {
                ...
                var nextInstance = new Node(instance, GetLayouts(layout, newDepth), newDepth,
                    0 /* TODO: iterationsToGenerate */, nextId++);
