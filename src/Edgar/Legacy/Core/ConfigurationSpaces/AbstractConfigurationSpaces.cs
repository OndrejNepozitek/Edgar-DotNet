...
namespace Edgar.Legacy.Core.ConfigurationSpaces
{
    ...
    /// </summary>
    public abstract class AbstractConfigurationSpaces<TNode, TShapeContainer, TConfiguration> :
        IConfigurationSpaces<TNode, TShapeContainer, TConfiguration, ConfigurationSpace>, IRandomInjectable
        where TConfiguration : IConfiguration<TShapeContainer, TNode>
    {
        ...
        /// <inheritdoc />
        public Vector2Int GetRandomIntersectionPoint(TConfiguration mainConfiguration,
            IList<TConfiguration> configurations)
        {
        ...
        /// <inheritdoc />
        public Vector2Int GetRandomIntersectionPoint(TConfiguration mainConfiguration,
            IList<TConfiguration> configurations, out int configurationsSatisfied)
        {
        ...
        /// <inheritdoc />
        public IList<OrthogonalLineGrid2D> GetMaximumIntersection(TConfiguration mainConfiguration,
            IList<TConfiguration> configurations)
        {
        ...
        /// <returns></returns>
        protected abstract IList<Tuple<TConfiguration, ConfigurationSpace>> GetConfigurationSpaces(
        ...
        /// <returns></returns>
        public abstract ConfigurationSpace GetConfigurationSpace(TConfiguration mainConfiguration,
            TConfiguration configuration);

        /// <inheritdoc />
        public abstract ConfigurationSpace GetConfigurationSpace(TShapeContainer movingPolygon,
