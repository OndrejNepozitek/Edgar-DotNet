...
namespace Edgar.Legacy.Core.Constraints
{
    ...
    public class
        BasicConstraint<TLayout, TNode, TConfiguration, TEnergyData, TShapeContainer> : INodeConstraint<TLayout, TNode,
            TConfiguration, TEnergyData>
        ...
        where TEnergyData : INodeEnergyData, new()
    {
        ...
        private readonly IConfigurationSpaces<TNode, TShapeContainer, TConfiguration, ConfigurationSpace>
            configurationSpaces;

        public BasicConstraint(IPolygonOverlap<TShapeContainer> polygonOverlap, float averageSize,
        ...
        {
            return polygonOverlap.OverlapArea(configuration1.ShapeContainer, configuration1.Position,
        ...
        {
            var distance = Vector2Int.ManhattanDistance(
