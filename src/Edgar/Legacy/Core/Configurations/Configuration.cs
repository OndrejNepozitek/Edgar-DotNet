...
namespace Edgar.Legacy.Core.Configurations
{
    ...
    public class Configuration<TEnergyData> : IEnergyConfiguration<IntAlias<PolygonGrid2D>, int, TEnergyData>,
        ISmartCloneable<Configuration<TEnergyData>>, IEnergyConfiguration<TEnergyData>
        where TEnergyData : IEnergyData, ISmartCloneable<TEnergyData>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is Configuration<TEnergyData> configuration &&
                   EqualityComparer<IntAlias<PolygonGrid2D>>.Default.Equals(ShapeContainer,
                       configuration.ShapeContainer) &&
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 +
                       EqualityComparer<IntAlias<PolygonGrid2D>>.Default.GetHashCode(ShapeContainer);
