...
namespace Edgar.GraphBasedGenerator.GridPseudo3DOld
{
    ...
    /// </summary>
    public class RoomTemplateGridPseudo2D
    {
        /// <summary>
        ...
        public RoomTemplateGridPseudo2D(PolygonGrid2D outline, IDoorModeGrid2D doors, string name = null, RoomTemplateRepeatMode? repeatMode = null, List<TransformationGrid2D> allowedTransformations = null)
        {
            Outline = outline;
            Doors = doors;
