...
namespace Edgar.GraphBasedGenerator.Common.Configurations
{
    ...
    /// </summary>
    public struct EnergyData : IEnergyData, IBasicConstraintData, ICorridorConstraintData,
        IMinimumDistanceConstraintData, ISmartCloneable<EnergyData>
    {
        /// <inheritdoc />
        ...
        public EnergyData(float energy, bool isValid, BasicConstraintData basicConstraintData,
            CorridorConstraintData corridorConstraintData, MinimumDistanceConstraintData minimumDistanceConstraintData)
        {
            Energy = energy;
            IsValid = isValid;
