...
namespace Edgar.GraphBasedGenerator.Grid2D.Internal
{
    public class DirectedConfigurationSpacesGenerator
    {
        ...
        public DirectedConfigurationSpacesGenerator(IPolygonOverlap<PolygonGrid2D> polygonOverlap,
            ILineIntersection<OrthogonalLineGrid2D> lineIntersection, IDoorSocketResolver doorSocketResolver = null)
        {
        ...
        public ConfigurationSpace GetConfigurationSpaceOverCorridors(RoomTemplateInstanceGrid2D roomTemplateInstance,
            ...
            ConfigurationSpaceDirection direction)
        {
        ...
        public ConfigurationSpace GetConfigurationSpaceOverCorridor(PolygonGrid2D polygon,
            ...
            PolygonGrid2D corridor, List<DoorLineGrid2D> corridorDoorLines, ConfigurationSpaceDirection direction)
        {
            var fixedAndCorridorConfigurationSpace =
                GetConfigurationSpace(corridor, corridorDoorLines, fixedPolygon, fixedDoorLines, direction);
            ...
            var configurationSpace =
                GetConfigurationSpace(polygon, doorLines, fixedPolygon, newCorridorDoorLines, direction);
        ...
        private ConfigurationSpaceGrid2D GetConfigurationSpace(PolygonGrid2D polygon, List<DoorLineGrid2D> doorLines,
            PolygonGrid2D fixedCenter, List<DoorLineGrid2D> doorLinesFixed, ConfigurationSpaceDirection direction,
        ...
        public ConfigurationSpaceGrid2D GetConfigurationSpace(RoomTemplateInstanceGrid2D roomTemplateInstance,
            RoomTemplateInstanceGrid2D fixedRoomTemplateInstance, ConfigurationSpaceDirection direction,
            List<int> offsets = null)
        {
