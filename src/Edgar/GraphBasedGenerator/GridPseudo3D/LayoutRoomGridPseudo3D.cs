...
namespace Edgar.GraphBasedGenerator.GridPseudo3D
{
    ...
    public class LayoutRoomGridPseudo3D<TRoom>
	{
        ...
        /// </summary>
        public RoomTemplateGridPseudo3D RoomTemplate { get; }
        ...
        public LayoutRoomGridPseudo3D(TRoom room, PolygonGrid2D outline, Vector2Int position, bool isCorridor, RoomTemplateGridPseudo3D roomTemplate, RoomDescriptionGridPseudo2D roomDescription, TransformationGrid2D transformation)
		{
			Room = room;
			Outline = outline;
			Position = position;
