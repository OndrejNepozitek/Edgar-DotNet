...
namespace GUI.MapDrawing
{
    ...
    public class WFLayoutDrawer<TNode> : AbstractLayoutDrawer<TNode>
    {
        ...
        public Bitmap DrawLayout(MapLayout<TNode> layout, int width, int height, bool withNames = true,
            int? fixedFontSize = null, float? scale = null, Vector2Int? offset = null)
        {
