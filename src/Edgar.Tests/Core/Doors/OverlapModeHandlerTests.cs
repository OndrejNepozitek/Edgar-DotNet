...
namespace MapGeneration.Tests.Core.Doors
{
    ...
    public class OverlapModeHandlerTests
    {
            ...
            var expectedPositions = new List<DoorLine>()
            {
                ...
                new DoorLine(
                    new OrthogonalLineGrid2D(new Vector2Int(1, 5), new Vector2Int(1, 5),
                        OrthogonalLineGrid2D.Direction.Right), 1),
                ...
                new DoorLine(
                    new OrthogonalLineGrid2D(new Vector2Int(2, 0), new Vector2Int(2, 0),
                        OrthogonalLineGrid2D.Direction.Left), 1),
            };
        ...
        public void Rectangle_TwoOverlap()
        {
            ...
            {
                new DoorLine(
                    new OrthogonalLineGrid2D(new Vector2Int(0, 2), new Vector2Int(0, 2),
                        OrthogonalLineGrid2D.Direction.Top), 1),
                new DoorLine(
                    new OrthogonalLineGrid2D(new Vector2Int(3, 3), new Vector2Int(3, 3),
                        OrthogonalLineGrid2D.Direction.Bottom), 1),
            };
