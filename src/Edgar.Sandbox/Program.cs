...
namespace Sandbox
{
    ...
    internal static class Program
    {
        ...
        public static void CompareWithReference()
        {
            ...
            var benchmarkScenario = new BenchmarkScenario<IMapDescription<int>>("CorridorConfigurationSpaces", input =>
            {
                ...
                return new LambdaGeneratorRunner(() =>
                {
                    ...
                    var generatorRun = new GeneratorRun<AdditionalRunData<int>>(layout != null,
        ...
        //	return inputs;
        //}
        public static List<DungeonGeneratorInput<int>> GetMapDescriptionsSet(Vector2Int scale, bool withCorridors,
            List<int> offsets, bool canTouch, RoomTemplateRepeatMode? repeatModeOverride = null,
            BasicRoomDescription basicRoomDescription = null, string suffix = null)
        {
            ...
            {
                var mapDescription = MapDescriptionUtils.GetBasicMapDescription(GraphsDatabase.GetExample1(),
                    basicRoomDescription, corridorRoomDescription, withCorridors);
            ...
            {
                var mapDescription = MapDescriptionUtils.GetBasicMapDescription(GraphsDatabase.GetExample2(),
                    basicRoomDescription, corridorRoomDescription, withCorridors);
                var configuration = new DungeonGeneratorConfiguration<int>()
                {
                    RoomsCanTouch = canTouch,
            ...
            {
                var mapDescription = MapDescriptionUtils.GetBasicMapDescription(GraphsDatabase.GetExample3(),
                    basicRoomDescription, corridorRoomDescription, withCorridors);
                var configuration = new DungeonGeneratorConfiguration<int>()
                {
                    RoomsCanTouch = canTouch,
                ...
                inputs.Add(new DungeonGeneratorInput<int>(
                    MapDescriptionUtils.GetInputName("Example 3 (fig. 7 bottom)", scale, withCorridors, offsets,
                        canTouch, suffix),
                    mapDescription,
                    configuration,
                    offsets
            ...
            {
                var mapDescription = MapDescriptionUtils.GetBasicMapDescription(GraphsDatabase.GetExample4(),
                    basicRoomDescription, corridorRoomDescription, withCorridors);
                var configuration = new DungeonGeneratorConfiguration<int>()
                {
                    RoomsCanTouch = canTouch,
            ...
            {
                var mapDescription = MapDescriptionUtils.GetBasicMapDescription(GraphsDatabase.GetExample5(),
                    basicRoomDescription, corridorRoomDescription, withCorridors);
                var configuration = new DungeonGeneratorConfiguration<int>()
                {
                    RoomsCanTouch = canTouch,
