...
namespace MapGeneration.IntegrationTests.Core.MapDescriptions
{
    ...
    public class MapDescriptionMappingTests
    {
        ...
        {
            var roomTemplate1 = new RoomTemplate(GridPolygon.GetSquare(10), new OverlapMode(1, 0));
            var roomTemplate2 = new RoomTemplate(GridPolygon.GetRectangle(5, 10), new OverlapMode(1, 0));
